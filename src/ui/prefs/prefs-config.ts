...
export const PREFS_LOCALE_KEY = "dinox:locale";
...
export function loadPrefs(): {
  ...
  if (typeof window === "undefined") {
    return { weekStart: "monday", defaultView: "month", timeFormat: "24h", accentColor: DEFAULT_ACCENT, appLocale: "en" };
  }
  ...
  const lc = localStorage.getItem(PREFS_LOCALE_KEY);
